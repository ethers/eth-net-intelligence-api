...
Node.prototype.getHistory = function(range)
{
	...
	if( !_.isUndefined(range) && !_.isUndefined(range.list) )
	{
		interv = {
			min: 0,
	...
	{
		var block = this.getBlock(( !_.isUndefined(range) && !_.isUndefined(range.list) ? range.list[i] : i));
